...
- [x] Home view: pinned playlist section (`Features/Home/HomeView.swift`) — no longer a placeholder, but still only this one section. Recently played, random suggestions, and "Listen List" remain unbuilt.
